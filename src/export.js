...
import { download, slug, toast, el } from './util.js?v=18';
import { store, imagesAsDataURLs, addImageFromFile, createNew, fetchFicha, setCurrentSilent, setCurrent } from './store.js?v=18';
import { newFicha } from './model.js?v=18';
